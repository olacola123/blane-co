...
Expense mapping: 6340=IT, 6500=office/rekvisita, 6800=other, 7100=vehicle, 7140=travel, 6540=kontor"""
        ...
        return f"""{R_VOUCHER}
═══ RECEIPT VOUCHER ═══
ACCOUNT MAPPING (by product type, NOT by department):
6340=IT/data/USB/PC/laptop/skjerm/tastatur/kabel/adapter/hub/elektronikk/programvare/software
7140=reise/travel/tog/togbillett/fly/flyreise/hotell/taxi/buss/ferge
7100=bil/car/bensin/diesel/parkering/bompenger
6500=kontorrekvisita/papir/penn/konvolutter/toner
6540=kontormøbler/pult/stol/hylle/skap/møbler/inventar/renhold
7350=representasjon/restaurant/middag/gave/blomster
6900=telefon/mobiltelefon/telefonabonnement
6300=leie/husleie/kontorlokale
6350=strøm/elektrisitet/energi
7700=drift/vedlikehold/reparasjon
6800=andre (only if nothing else fits)
IMPORTANT: Choose account by WHAT WAS BOUGHT, not which department! USB-hub=6340, togbillett=7140.
POST /ledger/voucher: debit EXPENSE(vatType:{{{{id:1}}}}, department:{{{{id:DEPT}}}}), credit 1920(vatType:{{{{id:0}}}}).
ALWAYS include department on the expense posting! vatType 1=ingoing25%. Food: vatType 11(ingoing15%). Use RECEIPT DATE not today!"""
